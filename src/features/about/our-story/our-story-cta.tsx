...
export function OurStoryCTA() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, #0a0614 0%, #12062a 40%, #0a1020 70%, #0a0614 100%)",
      }}
    >
      <div
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          <h2
            className="text-[clamp(3rem,8vw,7rem)] font-bold tracking-[-0.04em] leading-[0.96] text-white"
          ...
          <p className="text-xl md:text-2xl text-white/55 font-light leading-relaxed max-w-2xl mx-auto">
            Something steady, thoughtful, and long-term. If any of this
            resonated &mdash; you already belong here.
          </p>
